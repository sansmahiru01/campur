...
CFonts.say("SC PAIRING BY RIOO OFFCIAL", {
   font: 'chrome',
  align: 'left',
  gradient: ['red', 'magenta'],
});
CFonts.say(
  "Sc Bot By Rioo\nBase: Ori RafatharOffcial\nRecodeBy:RiooOffcial\ncampuran\nRuning:Panel\n\n\nSc Ini Di Recode Rafathar Kalo Kethauan Jual Murah Sc inI gua Banned Nyawa Lu Jarak Jauh\n\n\n",
  {
    colors: ["system"],
    font: "console",
    align: "center",
